...
public:
  ...
  // exception interface
public:
  virtual const char* what() const noexcept override { return "class ::Err;"; }
...
#define ERR_WHAT(cls) "class ::err::" #cls ";"
...
public:
  ...
  // Err interface
public:
  virtual std::string info() const override { return what(); }
};
...
public:
  ...
  // Err interface
public:
  virtual std::string info() const override { return strerror(_errnum); }
};
